...
public:
    int myAtoi(string str) {
        ...
        while(i < str.size() && (str[i] - '0' <= 9) && (str[i] -'0' >= 0)){
            if(sign == 1 && ((result > INT_MAX / 10) || (result == INT_MAX / 10 && (str[i] - '0' >= INT_MAX % 10)))){
                return INT_MAX;
            }else if(sign == -1 && ((result > INT_MAX / 10) || (result == INT_MAX / 10 && (str[i] - '0' > INT_MAX % 10)))){
                return INT_MIN;
            }
